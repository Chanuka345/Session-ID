...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'Chanukamadushan889@gmail.com', // Your Mega A/c Email Here
            password: 'Chanuka2007#' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? '𝐂𝐇𝐀𝐍𝐔𝐊𝐀-𝐌𝐃=' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of CHANUKA-MD .
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb35nfSDzgT59gD4SU11) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/Chanuka345/CHANUKA-MD-V1)  

🚀 _Thanks for choosing CHANUKA-MD — Let the automation begin!_ ✨`;
